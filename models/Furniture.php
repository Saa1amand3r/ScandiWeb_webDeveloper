...
include_once ('Product.php');
    ...
    class Furniture extends Product{
        ...
        public function save() {
            ...
            $stmt = $dbCon->prepared_query($link, Furniture::SQL_SAVE_TO_PRODUCT, [$this->sku]);
            $stmt->store_result();

            $lastId = $link->insert_id;
            $stmt = $dbCon->prepared_query($link, Furniture::SQL_SAVE_VALUES_TO_PRODUCT_FURNITURE, [$lastId, $this->price,$this->sku, $this->name,
